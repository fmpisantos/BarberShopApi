...
public interface IHistoryRepository extends JpaRepository<History, Long> {
    ...
    @Query(value = "SELECT H.*, S.name as serviceName, S.duration as duration, B.name as barberName, C.name as clientName " +
            ...
            "WHERE H.shop_id = :shopId AND H.date_time::::varchar LIKE :datetime ", nativeQuery = true)
    ...
    @Query(value = "SELECT H.*, S.name as serviceName, S.duration as duration, B.name as barberName, C.name as clientName " +
            ...
            "INNER JOIN barber B ON B.id = H.barber_id " +
            "INNER JOIN client C ON C.id = H.client_id " +
            "WHERE H.barber_id = :barberId AND H.date_time::::varchar LIKE :datetime ", nativeQuery = true)
    ...
    @Query(value = "SELECT H.*, S.name as serviceName, S.duration as duration, B.name as barberName, C.name as clientName " +
            ...
            "INNER JOIN barber B ON B.id = H.barber_id " +
            "INNER JOIN client C ON C.id = H.client_id " +
            "WHERE H.shop_id = :shopId AND H.barber_id = :barberId AND H.date_time::::varchar LIKE :datetime ", nativeQuery = true)
    ...
    @Query(value = "SELECT H.*, S.name as serviceName, S.duration as duration, B.name as barberName, C.name as clientName " +
            ...
            "INNER JOIN barber B ON B.id = H.barber_id " +
            "INNER JOIN client C ON C.id = H.client_id " +
            "WHERE H.client_id = :clientId AND H.date_time::::varchar LIKE :datetime ", nativeQuery = true)
